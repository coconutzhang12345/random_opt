"""
This file is from mlrose_hiive library.
https://github.com/hiive/mlrose/blob/master/mlrose_hiive/generators/tsp_generator.py


Rollings, A. (2020). mlrose: Machine Learning, Randomized Optimization and SEarch package for Python, hiive extended remix. https://github.com/hiive/mlrose. 
